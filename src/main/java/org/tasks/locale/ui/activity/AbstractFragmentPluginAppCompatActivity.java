...
public abstract class AbstractFragmentPluginAppCompatActivity extends AppCompatActivity {

    private static final Logger log = LoggerFactory.getLogger(AbstractFragmentPluginAppCompatActivity.class);
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (isLocalePluginIntent(getIntent())) {
            ...
            log.debug("Creating Activity with Intent={}, savedInstanceState={}, EXTRA_BUNDLE={}",
